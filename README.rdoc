...
At the moment all the users are regular users by default. To promote the user to an admin role use +rails console+ and update the users +admin+ parameter to +true+.
